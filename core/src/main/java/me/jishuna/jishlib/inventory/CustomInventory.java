...
public class CustomInventory<T extends Inventory> {
    ...
    public void setItem(int slot, ItemSupplier supplier) {
        setItem(slot, supplier.get());
    }
    ...
    public void setItem(ItemSupplier supplier, int... slots) {
        for (int i : slots) {
            setItem(i, supplier);
        }
    }
    ...
    public void setItem(ItemSupplier supplier, Collection<Integer> slots) {
        slots.forEach(i -> setItem(i, supplier));
    }
    ...
    public void setButton(int slot, ItemSupplier supplier, Consumer<ClickContext> consumer) {
        this.buttons.put(slot, consumer);
